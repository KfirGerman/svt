...
{
    /// <summary>
    /// Represents a factory for creating diagnostic tests for Storage components.
    /// </summary>
    public class StorageDiagnosticFactory : HardwareDiagnosticFactoryBase
    {
        /// <summary>
        /// Initializes a new instance of the StorageDiagnosticFactory class.
        /// </summary>
        /// <param name="systemInfo">The SystemInfo instance containing information about the system's hardware components.</param>
        public StorageDiagnosticFactory(SysInfo systemInfo) : base(systemInfo)
        {
        }
        ...
        {
            // TODO: create a list of all available diagnostic tests for Storage components and add them to the dictionary
        }
        ...
        protected override IDiagnosticTest? CreateDiagnosticTest(string testName)
        {
            ...
            {
                case "storage profile compare":
                    IList<IStorage> _storageList = _systemInfo.StorageList;
                    var profileCompare = new ProfileCompare<IStorage>("Storage Profile Compare");
                    profileCompare.SetParameters(_storageList, "Storage");
