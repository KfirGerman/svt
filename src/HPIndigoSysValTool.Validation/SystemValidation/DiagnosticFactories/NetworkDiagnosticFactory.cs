...
{
    /// <summary>
    /// Represents a factory for creating diagnostic tests for Network components.
    /// </summary>
    public class NetworkDiagnosticFactory : HardwareDiagnosticFactoryBase
    {
        /// <summary>
        /// Initializes a new instance of the NetworkDiagnosticFactory class.
        /// </summary>
        /// <param name="systemInfo">The SystemInfo instance containing information about the system's hardware components.</param>
        public NetworkDiagnosticFactory(SysInfo systemInfo) : base(systemInfo)
        {
        }
        ...
        {
            // TODO: create a list of all available diagnostic tests for Network components and add them to the dictionary
        }
        ...
        protected override IDiagnosticTest? CreateDiagnosticTest(string testName)
        {
            ...
            {
                case "nic profile compare":
                    IList<INetworkCard> _NetworkList = _systemInfo.NetworkCardList;
                    var profileCompare = new ProfileCompare<INetworkCard>("NIC Profile Compare");
                    profileCompare.SetParameters(_NetworkList, "networkCard");
