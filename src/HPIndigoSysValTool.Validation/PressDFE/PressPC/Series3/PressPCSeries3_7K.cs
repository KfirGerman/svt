...
{
    public class PressPCSeries3_7K : AbstractPressMachine
    {
        private readonly HardwareDiagnosticFacade _diagnosticFacade = HardwareDiagnosticFacade.Instance;

        /// <summary>
        /// Initializes a new instance of the PressPCSeries3_7K class.
        /// </summary>
        public PressPCSeries3_7K() : base("3", "7K")
        {
            LoggerProvider.FileLogger.Information($"PressPCSeries3_7K instance created.");
        }
        ...
        public override DiagnosticTestResult RunDiagnosticTest(string testName, string hardwareComponentName)
        {
            ...
            {
                LoggerProvider.FileLogger.Error($"ExecutionFailed running diagnostics for PressPCSeries3_7K: {ex.Message}");
                throw;
            }
        }
